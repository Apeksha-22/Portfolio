...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className="py-20 px-4 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 transition-colors duration-300 relative overflow-hidden"
    >
